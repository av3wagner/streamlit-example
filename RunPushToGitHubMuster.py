file = open('C:\PROJEKTE2023\ALMATY2023\Logs.txt','w')
# cd C:\PROJEKTE2023\ALMATY2023\PushData
# Python RunPushToGitHub.PY
file.write('PushToGitHub-Programm Start \n')
file.write('-------------------------------------------------------------------------- \n')
import base64
import requests
import base64
...
def push_file(fileName, repo_slug, branch, user, token):
    ...
    try:
        ...
        print(rPut.text)
        print(e)
fileName="PostFooter.pdf"
repositoryName = "av3wagner/streamlit-example"
branch = "master"
username = "av3wagner"
token = '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'
