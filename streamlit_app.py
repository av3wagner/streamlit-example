...
if pdf_file is not None:
    ...
    with open(save_image_path, "wb") as f:
        ...
        with col2:  
            ...
            st.markdown("**2.**: Это первая редакция сборника, так называемы сигнальный вариан.")
            st.markdown("**3.**: Авторы продолжают работать дальше и расширять сборник. В скором времени он будет предложен вам для прочтения.")
