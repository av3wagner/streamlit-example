...
if pdf_file is not None:
    ...
    with open(save_image_path, "wb") as f:
        ...
        with col2:  
            ...
            st.markdown("***Дорогие земляки, жители села Ленинское, одноклассницы, одноклассники, бывшие ученики школы им В.И.Ленина!***")
            st.markdown("Вашему вниманию предлагаются воспоминания выпускников сш. им В.И.Ленина 1968 года. ")
            st.markdown("Это первая редакция сборника, так называемы сигнальный вариант. Авторы продолжают работать дальше и расширяют сборник.")
            st.markdown("В скором времени он будет предложен вам для ознакомления. Желаем вам приятного чтения!")
